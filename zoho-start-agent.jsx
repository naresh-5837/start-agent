...
export default function ZohoStartAgent() {
  ...
  return (
    <div style={{
      fontFamily:"'Outfit',sans-serif", height:"100vh",
      display:"flex", flexDirection:"column", background:"#F8F7FC", overflow:"hidden",
    }}>
      <style>{globalCSS}</style>

      {/* Header */}
      <div style={{
        padding:"12px 20px", background:"#fff", borderBottom:"1px solid #EEEDF2",
        ...
        <a href="https://www.zoho.com/start/" target="_blank" rel="noopener noreferrer"
          style={{
            ...
            boxShadow:"0 2px 6px rgba(108,99,255,0.16)",
          }}
          onMouseEnter={e => e.target.style.background = "#5B52E5"}
      ...
      <div style={{ flex:1, overflowY:"auto", padding:"20px 20px 10px" }}>
        ...
        {regComplete && (
          <SubmitBanner onSubmit={() => {
            setSubmitted(true);
            console.log("Submitted. Conversation:", messages);
          }} submitted={submitted} />
        )}
      ...
      {showPrompts && (
        <div style={{
          padding:"0 20px 8px", display:"flex", flexWrap:"wrap", gap:7,
          ...
          {QUICK_PROMPTS.map((p, i) => (
            <button key={i} onClick={() => sendMessage(p)}
              ...
              onMouseLeave={e => {
                e.target.style.borderColor = "#EEEDF2";
                e.target.style.color = "#2D2B3D";
      ...
      <div style={{
        ...
        borderTop:"1px solid #EEEDF2", flexShrink:0,
      }}>
        <div style={{ display:"flex", gap:8, alignItems:"center" }}>
          <input
            ...
            style={{
              ...
              outline:"none", background:"#FAFAFE", transition:"all 0.2s",
            }}
            onFocus={e => {
              e.target.style.borderColor = "#6C63FF";
              e.target.style.background = "#fff";
        ...
        <div style={{ textAlign:"center", marginTop:9, fontSize:10.5, color:"#B0AFBC" }}>
          Powered by Claude · General guidance only — not legal advice · <a href="https://www.zoho.com/start/" target="_blank" rel="noopener" style={{ color:"#6C63FF", textDecoration:"none" }}>zoho.com/start</a>
        </div>
      </div>
    </div>
  );
